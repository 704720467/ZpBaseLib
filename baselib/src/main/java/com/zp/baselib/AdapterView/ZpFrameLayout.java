package com.zp.baselib.AdapterView;
...
import com.zp.baselib.utils.ScreenUtil;
...
public class ZpFrameLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (!flag) {
            float scale = Math.min(ScreenUtil.getInstance(getContext()).getHorizontalScale(),
                    ScreenUtil.getInstance(getContext()).getVerticalScale());
            scale =ScreenUtil.getInstance(getContext()).getHorizontalScale();

...
import com.zp.baselib.utils.ProgressDialogUtil;
import com.zp.baselib.widget.immersion_bar.ImmersionBar;
...
public class BaseActivity extends FragmentActivity {
    ...
    public void setTitleBarPaddingTop(@IdRes int viewId) {
        View view = findViewById(viewId);
        if (view == null) return;
        ImmersionBar.setTitleBarPaddingTop(this, view);
    }
